...
def initialize_result_file():
    ...
    file.write("org_dataset,dataset,scenario,xgb_score,rfc_score,knn_score\n")

def score(dataset,suffix,scenario,X_train,y_train,X_test,y_test):
    ...
    file.write(dataset+","+dataset+'_'+str(suffix)+","+scenario+","+str(xgb_score)+","+str(rfc_score)+","+str(knn_score)+"\n")